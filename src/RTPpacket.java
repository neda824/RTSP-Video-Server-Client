...
public class RTPpacket{
    ...
    //--------------------------
    public RTPpacket(int PType, int Framenb, int Time, byte[] data, int data_length, BufferedWriter log_file){
    ...
    //--------------------------
    public RTPpacket(byte[] packet, int packet_size, BufferedWriter log_file)
    {
    	this.logFile = log_file;
        //fill default fields:
        Version = 2;
